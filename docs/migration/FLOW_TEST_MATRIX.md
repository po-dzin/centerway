...
1. **Entry and view landing**
   ...
   - Assert precheckout modal/form/name/email/phone fields on both landings.
2. **Click CTA**
   - Assert both landings use precheckout and post to `/api/checkout/start`.
3. **Fill form (IREM)**
...
- `npm run userflows` (`platform/tests/userflows.ts`)
