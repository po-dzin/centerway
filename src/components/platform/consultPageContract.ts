...
export const consultationSteps = [
  ...
  },
  {
    id: "assessment",
    title: "Розбір стану",
    text: "На зустрічі розбираємо конституцію, тіло і травлення, сон і енергію, емоційний фон, ясність думок, харчування і ритм життя як одну картину.",
  },
  {
    id: "plan",
...
export const consultationExpectations = [
  ...
  "Розбір стану тіла, емоцій і ресурсу, конституції, харчування і ритму життя",
