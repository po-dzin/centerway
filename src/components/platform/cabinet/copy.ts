...
export function getCabinetCopy(lang: ProfileLang): CabinetCopy {
  if (lang === "en") {
    return {
      ...
      roomEnter: (label) => `Open the ${label} shelf`,
      roomBack: "Back to all materials",
  ...
  return {
    ...
    accountLead: "За цими контактами ми знаходимо ваші замовлення і пишемо вам про доступ.",

    notificationsTitle: "Нагадування про курс",
    notificationsLinked: "Telegram підключено — нагадування про уроки приходять туди.",
    notificationsMissing:
      "Telegram не підключено, тому нагадування про уроки до вас не дійдуть. Підключення займає один дотик.",
    connectTelegram: "Підключити Telegram",
    notificationsUnavailable: "Підключити Telegram зараз не вийшло. Нічого не втрачено — спробуйте пізніше.",
    ...
    shelfErrorLead: "Решта кабінету на місці. Спробуйте завантажити курси ще раз.",
