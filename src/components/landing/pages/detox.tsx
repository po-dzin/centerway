...
type DetoxLandingPageProps = {
  ctaPrimaryLabel?: string;
  generatorContext?: GeneratorAnalyticsContext;
};

export function DetoxLandingPage({ ctaPrimaryLabel = "Записатися", generatorContext }: DetoxLandingPageProps) {
  useLandingRuntime({
    product: "detox",
          ...
          <header className="hero section" id="top">
            <div className="container reveal">
              <div className="hero-headline">
                <span className="eyebrow">CENTERWAY DETOX</span>
              ...
              <div className="container reveal">
                ...
                <div className="pricing-card role-pricing-card" data-price-value="3600">
                  <div className="pricing-main">
                    <p className="pricing-label">Detox 21</p>
