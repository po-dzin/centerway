...
export const LANDING_CONTENT: Record<StaticLandingProduct, LandingProductContent> = {
  short: {
    ...
    description: "3 комплекси вправ. Швидко відновлюють тіло та розум. Всього 15 хвилин на день.",
    hero: {
      badge: "АВТОРСЬКИЙ КУРС",
      title: "Short-Перезавантаження",
      subtitle: "3 комплекси вправ. Швидко відновлюють тіло та розум. Всього 15 хвилин на день.",
      lead: "Інтегруйте цей метод в своє життя і ви отримаєте:",
      chips: ["Зниження стресу та покращення сну", "Збільшення рівня енергії", "Зміцнення здоров'я"],
  ...
  irem: {
    ...
    description: "Інтегральна відновлювальна енергомодулююча гімнастика для енергії, тонусу та стабільного стану.",
    hero: {
