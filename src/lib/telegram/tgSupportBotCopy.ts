...
export const botCopy = {
  ...
  faq: {
    ...
    schedule: [
      "Чи можна дивитися уроки наперед, залежить від курсу: в одних усі уроки відкриті одразу, в інших вони відкриваються по черзі або по днях. Це видно в змісті курсу.",
      "",
