...
export const journeySteps = [
  ...
  { id: "signals", title: "Сигнали стану", text: "Що тіло, емоції й думки кажуть про перевантаження — і чому це не «поломка»?" },
  { id: "method", title: "Метод", text: "Як працює м'яке відновлення через тіло, харчування, увагу і ритм життя?" },
...
export const bodySignals = [
  ...
  "Набряки, зміни ваги, дискомфорт травлення, шкіра як індикатор перевантаження",
  "Тривожність, дратівливість або апатія, емоційні гойдалки",
  "Розсіяність, важко зосередитися, думки не зупиняються",
  "Темп життя і навантаження, у яких губиться контакт із собою і тілом",
];
...
export const platformEntryCards = [
  {
    ...
    text: "Почати не з програми, а з чесної картини: тіло і травлення, сон і енергія, емоційний фон, ясність думок і темп життя навколо.",
    visual: "state",
  },
  {
    label: "Метод",
    title: "Побачити свою конституцію",
    text: "Тест доші і консультація допомагають перекласти те, що ви відчуваєте в тілі, емоціях і думках, у зрозумілу мову ритму, харчування і практики.",
    visual: "method",
  },
  {
    label: "Маршрут",
...
export const doshas = [
  ...
  {
    title: "Очищення",
    text: "М'яке звільнення від накопиченого перевантаження — у тілі, в емоціях і в голові — без насильства над собою і без екстремальних режимів.",
  },
  {
    title: "Практика і ритм",
    text: "Рух, дихання, сон і побутові опори повертають зібраність, легкість, емоційну рівновагу і стабільний контакт із собою.",
  },
];
...
export const consultationCopy = {
  ...
  text: "Не «просто порада», а персональний план відновлення: стан тіла, емоцій і ресурсу, конституція, харчування, очищення, ритм життя і наступні кроки без зайвого тиску.",
};
