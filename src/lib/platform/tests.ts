...
export const platformTests: PlatformTestEntry[] = [
  {
    ...
    reads: "тіло, травлення, сон, енергія, емоції, мислення, темп",
    visual: "stone",
    artwork: {
  ...
  },
  {
    ...
    format: "готуємо",
    description:
      "Окремий зріз про апетит, регулярність, реакцію на їжу і те, як травлення відгукується на стрес і емоції, — щоб бачити, що саме зараз його перевантажує, а не лише загальний тип конституції.",
    reads: "апетит, регулярність, реакція на їжу, стрес",
    visual: "leaf",
    status: "planned",
  },
  {
    ...
    format: "готуємо",
    description:
      "Зріз про втому, сон, емоційне виснаження і темп: коли ресурс ще тримається, а коли режим уже працює проти вас і потрібна не програма, а пауза.",
    reads: "втома, сон, емоції, темп, відновлення",
    visual: "water",
    status: "planned",
  },
  {
    ...
    format: "готуємо",
    description:
      "Зріз про ритм життя: час сну, їжі, руху і пауз, навантаження і спілкування — щоб побачити, які прості зміни дадуть найбільше при найменшому тиску.",
    reads: "сон, їжа, рух, паузи, навантаження, оточення",
    visual: "mountain",
    status: "planned",
  },
];
...
export const testsHubCopy = {
  ...
  title: "Діагностика",
  lead: "Тести не ставлять діагноз. Вони перекладають ваш поточний стан — тіла, емоцій, думок і ресурсу — у зрозумілу мову ритму, харчування і практики і показують, з якого кроку доречно починати.",
  ...
  /* The block had a label and no title, so it was the one section on the page
     ...
     line. An eyebrow names the part of the journey; it is not a heading. */
  readingTitle: "Що тест каже, а що ні",
  readingItems: [
    ...
    "Стан змінюється, тому тест доречно повторювати, коли змінюються сон, харчування, емоційний фон або навантаження.",
  ...
  bridgeLead:
    "Тест дає напрямок, але не читає контекст: історію, обмеження, життєві обставини, поточні навантаження і те, що вже пробували. Для цього є консультація — там стан збирається разом і план стає персональним.",
