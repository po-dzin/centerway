...
export const testsHubCopy = {
  ...
  bridgeLead:
    "Тест дає напрямок, але не читає контекст: історію, обмеження, поточні навантаження і те, що вже пробували. Для цього є консультація — там стан збирається разом і план стає персональним.",
