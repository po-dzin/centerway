...
export const platformTests: PlatformTestEntry[] = [
  ...
  },
  {
    ...
    format: "готуємо",
    description:
      "Зріз про ритм життя: час сну, їжі, руху, пауз і навантаження — щоб побачити, які прості зміни дадуть найбільше при найменшому тиску.",
    reads: "сон, їжа, рух, паузи, навантаження",
    visual: "mountain",
    status: "planned",
  },
];
