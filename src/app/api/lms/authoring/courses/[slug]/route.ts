 ...
 *
 * Identity, permission and rate limit all come from `withCourseAccess`, which
 * is the same function an agent tool calls (docs/agent-contour-2026-08-21.md
 * §2). A course this identity may not edit answers 404, not 403: whether a
 * course exists is not information an unauthorised caller is owed.
 */

import { revalidateTag } from "next/cache";
import { NextRequest, NextResponse } from "next/server";

import { builderCourseSlugCanChange, deleteBuilderCourse, isDraftGeneration, renameBuilderCourseSlug, saveBuilderCourse } from "@/lib/lms/builder";
