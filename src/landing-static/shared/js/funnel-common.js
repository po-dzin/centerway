/* THE FUNNEL LANDINGS' ONE SCRIPT (2026-09-11).
   way21, irem, reset-day, short and short-b each shipped their own js/common.js
   — 400 to 583 lines — differing in the five constants at the top and in two
   features, each harmless where a page does not use it: way21's per-button
   package selection and short's scroll-to buttons. The page widgets (accordion,
   sticky menu, carousel) are NOT here; see landing-widgets.js. This is way21's
...
(function() {
  ...
  document.addEventListener("click", function(event) {
    ...
    if (trigger) {
      ...
      // A hero or sticky button may scroll to the offer instead of paying;
      // the WayForPay redirect then happens from the button inside the offer.
      // (short's pages carry data-scroll-to; the others never did.)
