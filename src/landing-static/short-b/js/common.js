...
/* Variant B markup uses <details> for the FAQ, the .sticky-cta bar and reveal
   animations from enhance.js, so the DOM-widget initialisers of variant A
   (accordion / sticky menu / reviews carousel) are intentionally absent here.
   Everything above — checkout redirect, pixel + CAPI events, attribution —
   is byte-identical to short/js/common.js so the A/B arms are comparable. */
