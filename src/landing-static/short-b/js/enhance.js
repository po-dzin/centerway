/**
 * Short variant-B landing enhancements.
 *
 * Fork of irem/js/irem-enhance.js: reveal-on-scroll, sticky-CTA suppression
 * while a real CTA is on screen, smooth anchor scrolling and single-open FAQ.
 * Kept as a separate file so /reboot-b can be iterated without touching IREM.
 */
(function () {
  if (window.__shortBEnhanceInit) return;
  window.__shortBEnhanceInit = true;
