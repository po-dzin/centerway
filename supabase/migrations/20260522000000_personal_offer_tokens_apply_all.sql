-- CenterWay: one-shot personal_offer_tokens bootstrap / repair script.
-- Use this in Supabase SQL Editor when the environment may be missing
-- the table entirely or already have it in a partial / outdated shape.
