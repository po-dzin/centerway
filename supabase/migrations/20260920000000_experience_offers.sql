...
update public.experience_offers o
  ...
  ('course:way21', '{"uk":"Шлях 21 — інтегративна детокс-програма","en":"Way 21 — integrative detox program"}'::jsonb, '{"uk":"Оплата детокс-програми \"Шлях 21\" від Centerway. Після успішної оплати відкриється сторінка підтвердження та кнопка для входу в Telegram-бот - там буде ваш доступ і подальші інструкції. Підтримка: якщо виникли питання - напишіть нам, допоможемо швидко.","en":"Detox program payment by Centerway. After successful payment, a confirmation page will open with a Telegram bot entry button for your access and next steps. Support: if you have questions, message us and we will help quickly."}'::jsonb),
  ('course:reset-day', '{"uk":"Розвантажувальний день — міні-курс","en":"Reset Day — mini course"}'::jsonb, '{"uk":"Оплата міні-курсу \"Розвантажувальний день\" від Centerway. Після успішної оплати відкриється сторінка підтвердження та кнопка для входу в Telegram-бот - там буде ваш доступ і подальші інструкції. Підтримка: якщо виникли питання - напишіть нам, допоможемо швидко.","en":"Mini course payment by Centerway. After successful payment, a confirmation page will open with a Telegram bot entry button for your access and next steps. Support: if you have questions, message us and we will help quickly."}'::jsonb),
  ('way21-support', '{"uk":"Шлях 21 — індивідуальний супровід","en":"Way 21 — guided package"}'::jsonb, '{"uk":"Оплата пакета \"Шлях 21 — індивідуальний супровід\" від Centerway: програма детоксу з 2 особистими консультаціями та персональним веденням. Після оплати відкриється сторінка підтвердження та кнопка для входу в Telegram-бот. Підтримка: якщо виникли питання - напишіть нам, допоможемо швидко.","en":"Guided package payment by Centerway: the detox program with 2 personal consultations and individual guidance. After payment, a confirmation page opens with a Telegram bot entry button. Support: if you have questions, message us and we will help quickly."}'::jsonb),
