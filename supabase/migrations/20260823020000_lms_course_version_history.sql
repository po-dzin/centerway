-- RECOVERED FROM THE JOURNAL on 2026-09-11.
--
-- This change was applied to production on 2026-08-23
-- and its SQL was never committed. `npm run check:migration-drift` found it:
-- a version in supabase_migrations.schema_migrations with no file here. The
-- text below is the 12 statements the journal stored, verbatim, so the
-- folder and the database say the same thing again.
--
-- See docs/adr/0001-migrations-live-in-supabase-migrations.md.
